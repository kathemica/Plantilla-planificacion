...
\titulo{Sistema de control de granja avícola} 
...
Debido a la necesidad de diseñar un sistema de bajo coste que esté acorde a los requerimientos actuales de tecnología, comunicaciones y seguridad en la cría de aves para consumo humano, se genera un proyecto que se destaca por la integración de diversas tecnologías que permitirán poner en funcionamiento un sistema automatizado de control de condiciones medioambientales en las naves de las granjas avícolas, garantizando así el poder adecuarlas a los valores  ideales que mantienen el confort y seguridad de los animales; de esta manera, se optimiza la granja para que las aves aseguren tanto la puesta de huevos como el crecimiento de las que están destinadas al consumo humano. El sistema busca  la captura y procesamiento de estas señales procurando la comunicación segura con el servidor que recibe y administra los datos, así mismo se busca incorporar actuadores para el control automático de la ventilación de las alas relacionados con el control de la temperatura, además de la gestión y monitoreo de las variables, alarmas, visualización de datos, reportes entre otros.
